...
public class SingletonWithPrototypeTest1 {
    ...
    public void singletonClientUsePrototype(){
        ...
        assertThat(count2).isEqualTo(1); // prototype 호출시 미리 주입된것을 가져오므로 초기값이 기존 수행된 값으로 가지게 된다.
...
//        private final PrototpyeBean prototpyeBean; // 생성시점에 주입, 미리 기존 주입이 되어 있으면 그대로 사용하게 된다. 따라서 싱글톤으로 사용시 문제가 발생될수 있다.
        ...
        @Autowired
        private Provider<PrototpyeBean> prototypeBeanProvider;
...
//        }
        ...
        public int logic(){
            PrototpyeBean prototypeBean = prototypeBeanProvider.get();
